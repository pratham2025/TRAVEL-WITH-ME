...
public class HHotels extends AppCompatActivity {
    WebView w1;
    public ProgressDialog progress1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hhotels);

        w1=(WebView) findViewById(R.id.webViewb);
        w1.getSettings().setJavaScriptEnabled(true);

        w1.loadUrl("https://www.tripadvisor.in/Hotels-g297617-Himachal_Pradesh-Hotels.html");
