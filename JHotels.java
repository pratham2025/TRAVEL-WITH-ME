...
public class JHotels extends AppCompatActivity {
    WebView w1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jhotels);

        w1=(WebView) findViewById(R.id.webViewb);
        w1.getSettings().setJavaScriptEnabled(true);

        w1.loadUrl("https://www.tripadvisor.in/Hotels-g297619-Jammu_and_Kashmir-Hotels.html");
