...
public class Maharashtra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] Places = {"Mumbai","Pune","Kolhapur","Satara", "Nashik"};
        ...
        final String[] Food = {"Puran Poli","Bharli Vangi","Pav Bhaji","Junka Bhakari","Modak"};
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(), MExplore.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(), MHotels.class);
                startActivity(intent);
            }
        });
