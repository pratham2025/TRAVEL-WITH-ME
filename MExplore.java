...
public class MExplore extends AppCompatActivity {
    WebView w1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mexplore);

        w1=(WebView) findViewById(R.id.webViewb);
        w1.getSettings().setJavaScriptEnabled(true);

        w1.loadUrl("https://www.google.com/maps/search/popular+places+in+maharashtra/@17.7149007,73.7740054,9.91z?entry=ttu");
