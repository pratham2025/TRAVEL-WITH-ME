...
public class HExplore extends AppCompatActivity {
    WebView w1;
    public ProgressDialog progress1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hexplore);

        w1=(WebView) findViewById(R.id.webViewb);
        w1.getSettings().setJavaScriptEnabled(true);

        w1.loadUrl("https://www.google.com/maps/search/popular+places+in+himachal+pradesh/@31.7937005,76.4135172,9z/data=!3m1!4b1?entry=ttu");
