...
public class Goa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] Places = {"Ponda","Candolim","Vasco Da Gama","CanaCona", "Valha Goa Vagator"};
        ...
        final String[] Food = {"Goan Fish Curri","Sorpotel","Sannas","Feni","Suran Fodi"};
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(), GExplore.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(), GHotels.class);
                startActivity(intent);
            }
        });
