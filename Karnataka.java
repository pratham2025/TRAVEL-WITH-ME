...
public class Karnataka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] Places = {"Banglore","Ooty","Mysore","Udupi", "Humpi"};
        ...
        final String[] Food = {"Khara Pongal","Chirote","Udupi Sambhar","MysorePak","Masala Dosa"};
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(), KaExplore.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(), KaHotels.class);
                startActivity(intent);
            }
        });
