...
public class MainActivity8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] Places = {"Kair","Taj Pul","Sambhalika","Alipur", "Chilli Sarda Banger"};
        ...
        final String[] Food = {"Paranthas","Chaat","Butter Chicken","Kebas","Biryani"};
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(), deexplore.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(), dehotel.class);
                startActivity(intent);
            }
        });
