...
public class JExplore extends AppCompatActivity {
    WebView w1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jexplore);

        w1=(WebView) findViewById(R.id.webViewb);
        w1.getSettings().setJavaScriptEnabled(true);

        w1.loadUrl("https://www.google.com/maps/search/popular+places+in+jammu+and+kashmir+to+travel/@33.5245666,73.9455553,8z/data=!3m1!4b1?entry=ttu");
