...
public class KeExplore extends AppCompatActivity {
    WebView w1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ke_explore);

        w1=(WebView) findViewById(R.id.webViewb);
        w1.getSettings().setJavaScriptEnabled(true);

        w1.loadUrl("https://www.google.com/maps/search/popular+places+in+kerala/@10.6415146,75.0562587,8z/data=!3m1!4b1?entry=ttu");
